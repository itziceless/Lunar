...
local getcustomassets = {
	...
	['newvape/assets/new/flag.png'] = 'rbxassetid://112802634401879',
}
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		modulebutton.Size = UDim2.fromOffset(210, 38)
...
function mainapi:CreateLegit()
	...
	function legitapi:CreateModule(modulesettings)
		...
		module.Position = UDim2.fromOffset(0, 5)
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/itziceless/Lunar/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
...
guipane:CreateDropdown({
	Name = 'GUI Theme',
	List = inputService.TouchEnabled and {'new', 'old', 'hack'} or {'new', 'old', 'rise', 'hack'},
