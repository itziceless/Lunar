...
run(function()
	...
	function whitelist:update(first)
		local suc = pcall(function()
			...
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/itziceless/whitelists/refs/heads/main/'..commit..'/PlayerWhitelist.json', true)
		end)
		...
		Function = function(callback)
			if callback then
				...
				if Texture.Value:find('.webm') then
					...
					decal.Image = Texture.Value ~= '' and (Texture.Value:find('rbxasset') and Texture.Value or assetfunction(Texture.Value)) or 'rbxassetid://10494153330' --'rbxassetid://14637958134' regular vape cape
					decal.Size = UDim2.fromScale(1, 1)
					decal.BackgroundTransparency = 1
					decal.Parent = capesurface
				end
